...
export function HardwareMonitor() {
  ...
  const [sensors, setSensors] = useState<SensorData[]>([
    { label: "CPU", value: 42, temp: 54, icon: <Cpu className="w-4 h-4" />, subtitle: "Intel Core i9" },
    { label: "RAM", value: 67, temp: 45, icon: <MemoryStick className="w-4 h-4" />, subtitle: "21.4 / 32 GB" },
    { label: "GPU", value: 38, temp: 62, icon: <Monitor className="w-4 h-4" />, subtitle: "RTX 4090" },
  ])
  const { t } = useI18n()
