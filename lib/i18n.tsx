...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "music.title": "YouTube",
    "music.embedHint": "Pega un enlace de YouTube y reproduce el video aqui, dentro del panel.",
    "music.paste": "Pegar enlace de video",
    "music.play": "Reproducir",
    "music.empty": "El video aparecera aqui",
    ...
    "settings.upToDate": "Ya tienes la ultima version",
    "settings.updateInstalled": "Actualizacion instalada. Reinicia Sideglass.",
  ...
  en: {
    ...
    "music.title": "YouTube",
    "music.embedHint": "Paste a YouTube link and play the video here, inside the dashboard.",
